...
export default async function AuditorLayout({
  ...
  const session = await requireRole(["SUPER_ADMIN", "AUDITOR"]);
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 border-b border-[#ebd7ba]/80 bg-white px-3 sm:px-4 flex items-center justify-between sticky top-0 z-20 shadow-sm">
          <h2 className="text-sm font-bold text-slate-900">
            Panel Auditor Lembaga Pemeriksa Halal (LPH)
          </h2>
